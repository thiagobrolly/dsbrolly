...
var Separator = function (_a) {
    ...
    return (React.createElement(Wrapper, __assign({ color: color, marginTop: marginTop, marginBottom: marginBottom }, props)));
};

var mediaFont = function () { return css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  @media (max-width: ", ") {\n    font-size: ", ";\n  }\n"], ["\n  @media (max-width: ", ") {\n    font-size: ", ";\n  }\n"])), theme.breakpoints.tablet, theme.font.size.xxlarge); };
var titleSize = {
    small: function () { return css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    font-size: ", ";\n  "], ["\n    font-size: ", ";\n  "])), theme.font.size.small); },
    medium: function () { return css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    font-size: ", ";\n  "], ["\n    font-size: ", ";\n  "])), theme.font.size.medium); },
    large: function () { return css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    font-size: ", ";\n  "], ["\n    font-size: ", ";\n  "])), theme.font.size.large); },
    xlarge: function () { return css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    font-size: ", ";\n  "], ["\n    font-size: ", ";\n  "])), theme.font.size.xlarge); },
    big: function () { return css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    font-size: ", ";\n    ", ";\n  "], ["\n    font-size: ", ";\n    ", ";\n  "])), theme.font.size.big, mediaFont()); },
};
var titleColor = {
    white: function () { return css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    color: ", ";\n  "], ["\n    color: ", ";\n  "])), theme.color.white); },
    gray: function () { return css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    color: ", ";\n  "], ["\n    color: ", ";\n  "])), theme.color.title); },
    black: function () { return css(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    color: ", ";\n  "], ["\n    color: ", ";\n  "])), theme.color.black_700); },
};
var titleCase = function (uppercase) { return css(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  text-transform: ", ";\n"], ["\n  text-transform: ", ";\n"])), uppercase ? 'uppercase' : 'none'); };
var Title = styled.h1(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (_a) {
...
var Heading = function (_a) {
    ...
    return (React.createElement(Title, __assign({ as: as, size: size, uppercase: uppercase, bold: bold, color: color }, props), children));
};

export { Heading, Separator, theme };
